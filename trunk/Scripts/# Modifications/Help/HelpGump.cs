...
*/
				...
				AddHtml( 110, 140, 450, 58, @"<u>Question générale.</u> Selectionnez cette option pour une question sur Terra Nubia.", true, true );
			...
			/*	AddButton( 80, 205, 5540, 5541, 2, GumpButtonType.Reply, 0 );
                ...
                */
				...
				AddHtml( 110, 270, 450, 58, @"<u>J'ai un soucis.</u> Un problème avec un joueur, une scène RP ou une demande d'assistance pour vous aider dans une scène ou un projet.", true, true );
*/
                AddButton(80, 335, 5540, 5541, 6, GumpButtonType.Reply, 0);
				AddHtml( 110, 335, 450, 58, @"<u>Autre.</u> Toute autre demande.", true, true );
			}
			else
			{
