...
namespace Server.Items
{
	public class ParagonChest : LockableContainer
	{
		...
		private void Fill( int level )
		{
			...
			switch ( level )
			{
				case 1: Serrure = SerrureQuality.Simple; break;
                case 2: Serrure = SerrureQuality.Moyenne; break;
                case 3: Serrure = SerrureQuality.Bonne; break;
                case 4: Serrure = SerrureQuality.TresBonne; break;
                case 5: Serrure = SerrureQuality.Excellente; break;
			}
