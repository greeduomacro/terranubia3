...
{
	public interface IPuficateurLumiere
	{
		int MaxFlour{ get; }
	...
	public class PurificateurEauLumiere : BaseAddon, IPuficateurLumiere
	{
		public override BaseAddonDeed Deed{ get{ return new PurificateurEauLumiereDeed(); } }
		...
		public PurificateurEauLumiere()
		{
			...
			Hue = 2119;
			Name = "Purificateur d'Aqualide";
		}

		public PurificateurEauLumiere( Serial serial ) : base( serial )
		{
		}
	...
	public class PurificateurEauLumiereDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new PurificateurEauLumiere(); } }
		public override int LabelNumber{ get{ return 1044347; } } // flour mill (east)

		[Constructable]
		public PurificateurEauLumiereDeed()
		{
		}

		public PurificateurEauLumiereDeed( Serial serial ) : base( serial )
		{
		}
