...
{
    public class CompCouture : NubiaCompetence
    {
        public override string Name { get { return "Couture"; } }
        public override CompType CType { get { return CompType.Couture; } }
        ...
        public CompCouture(NubiaMobile m)
            : base(m)
        {
        }
