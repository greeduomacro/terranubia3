...
namespace Knives.TownHouses
{
	...
	public class SignHammerGump : GumpPlus
	{
		public static void SendTo( Mobile m, SignHammer hammer )
		{
			new SignHammerGump( m, hammer );
		}
		...
		protected override void BuildGump()
		{
			...
			AddButton( 50, 45, 2152, 2154, "Swap", new TimerCallback( Swap ) );
			AddHtml( 90, 50, 70, 40, "Swap Hanger", false, false );

			AddButton( 50, 95, 2152, 2154, "Slip", new TimerCallback( Flip ) );
			AddHtml( 90, 100, 70, 40, "Flip Sign or Hanger", false, false );
		}
