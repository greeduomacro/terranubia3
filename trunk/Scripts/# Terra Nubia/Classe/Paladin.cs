...
namespace Server
{
    public class ClassePaladin : Classe
    {
        ...
        public override ClasseType CType { get { return ClasseType.Paladin; } }
        ...
        public override CompType[] ClasseCompetences
        {
            get
            {
                 ...
                 * Connaissances (noblesse et royauté) (Int),
                 * Connaissances (religion) (Int), Diplomatie (Cha), 
                 * Dressage (Cha), Équitation (Dex), 
                 * Premiers secours (Sag), Profession (Int)
                 * et Psychologie (Sag).*/
                return new CompType[]{
