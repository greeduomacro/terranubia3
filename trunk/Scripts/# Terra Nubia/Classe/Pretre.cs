...
namespace Server
{
    public class ClassePretre : Classe
    {
        ...
        public override ClasseType CType { get { return ClasseType.Pretre; } }
        ...
        public override CompType[] ClasseCompetences
        {
            get
            {
                 ...
                 * Concentration (Con), Connaissances (histoire) (Int),
                 * Connaissances (mystères) (Int), Connaissances (plans) (Int),
                 * Connaissances (religion) (Int), Diplomatie (Cha),
                 * Premiers secours (Sag) et Profession (Sag).*/
                return new CompType[]{
                    CompType.ArtMagie,
        ...
        //BONUS CALQUE SUR LA CLASSE MAGICIEN...
