...
namespace Server.Misc
{
	public class Weather
	{
		...
		public static void Initialize()
		{
			...
			//test
			//AddWeather( -15, 100, 5, new Rectangle2D( 0, 0, 5120, 4096 ) );
		...
		/*	for ( int i = 0; i < 4; ++i )
				AddDynamicWeather( +15, 100, 5, 9, 800, 800, new Rectangle2D( 0, 0, 5120, 4096 ) );*/
		}
		...
		public virtual void OnTick()
		{
			...
			if ( m_Active )
			{
				...
				World.Broadcast( 0x35, true, "L'orage éclate dans un fracas assourdissant" );
