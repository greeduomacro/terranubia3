	...
	public class SBTailor: SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			//	Add( new GenericBuyInfo( typeof( UncutCloth ), 2, 20, 0x1767, Utility.RandomDyedHue() ) ); 
                ...
                Add(new GenericBuyInfo(typeof(TissuLin), 2, 20, 0x1766, Utility.RandomDyedHue()));
                Add(new GenericBuyInfo(typeof(TissuCoton), 3, 20, 0x1766, Utility.RandomDyedHue()));
                Add(new GenericBuyInfo(typeof(TissuSoie), 15, 2, 0x1766, Utility.RandomDyedHue())); 
