...
{
    public abstract class BaseUOWeapon : BaseMeleeWeapon, IUsesRemaining
    {
        ...
        public BaseUOWeapon(): this(3915){ }
        public BaseUOWeapon(int itemID)
            : base(itemID)
        {
            m_UsesRemaining = 150;
        }

        public BaseUOWeapon(Serial serial)
            : base(serial)
        {
        }
