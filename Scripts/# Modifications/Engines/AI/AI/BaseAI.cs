					...
					for( int i = 0; i < keywords.Length; ++i )
					{
						...
						switch( keyword )
						{
							case 0x164: // all come
							{
                                ...
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Come))
                                    break;
							...
							{
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Follow))
                                    break;
							...
							case 0x16B: // all guard me
							{
                                ...
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Guard))
                                    break;
							...
							case 0x167: // all stop
							{
								if( m_Mobile.CheckControlChance( e.Mobile ) )
								{
                                    if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Stop))
                                        break;
							...
							case 0x169: // all attack
							{
                                ...
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Attack))
                                    break;
							...
							case 0x170: // all stay
							{
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Stay))
                                    break;
					...
					for( int i = 0; i < keywords.Length; ++i )
					{
						...
						switch( keyword )
						{
							...
							case 0x156: // *drop
							{
                                ...
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Drop))
                                    break;
							...
							case 0x15B: // *friend
							{
                                ...
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Friend))
                                    break;
							...
							case 0x15F: // *patrol
							{
                                ...
                                if (!((NubiaCreature)m_Mobile).canDoOrder(OrderType.Patrol))
                                    break;
