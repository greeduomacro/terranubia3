...
{
	public interface IPuficateurTenebre
	{
		int MaxFlour{ get; }
	...
	public class PurificateurEauTenebre : BaseAddon, IPuficateurTenebre
	{
		public override BaseAddonDeed Deed{ get{ return new PurificateurEauTenebreDeed(); } }
		...
		private void FinishWorking_Callback( object state )
		{
			...
			if ( from != null && !from.Deleted && !this.Deleted && IsFull )
			{
				...
				BottleWater water = new BottleWater();
				//flour.ItemID = ( Utility.RandomBool() ? 4153 : 4165 );

				if ( from.PlaceInBackpack( water ) )
				{
					m_Flour = 0;
				}
				else
		...
		public override void OnComponentUsed( AddonComponent c, Mobile from )
		{
			if ( !from.InRange( GetWorldLocation(), 4 ) || !from.InLOS( this ) )
				...
				from.SendMessage("Vous avez besoin de plus d'Aqualide pour lancer la machine");
			else
				StartWorking( from );
		}

		[Constructable]
		public PurificateurEauTenebre()
		{
			...
			Hue = 1103;
			Name = "Purificateur de Putralide";
		}

		public PurificateurEauTenebre( Serial serial ) : base( serial )
		{
		}
	...
	public class PurificateurEauTenebreDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return new PurificateurEauTenebre(); } }
		public override int LabelNumber{ get{ return 1044347; } } // flour mill (east)

		[Constructable]
		public PurificateurEauTenebreDeed()
		{
		}

		public PurificateurEauTenebreDeed( Serial serial ) : base( serial )
		{
		}
