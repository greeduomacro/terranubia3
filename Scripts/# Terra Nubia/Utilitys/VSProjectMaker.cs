...
{ 
	...
	{ 
		...
		{ 
			World.Broadcast( 0x35, true, "Projectfile is being generated, please wait." );
			...
			World.Broadcast( 0x35, true, "Projectfile has been completed. The entire process took {0:F1} seconds.", (endTime - startTime).TotalSeconds );
		}
